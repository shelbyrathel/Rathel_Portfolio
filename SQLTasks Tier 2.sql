...
in question. */
SELECT name, IF(monthlymaintenance<100,'cheap','expensive') AS monthlymaintenance 
FROM Facilities;
...
SELECT C1.surname as membersurname, m1.firstname as memberfirstname, CONCAT( m2.firstname, ' ', m2.surname ) AS recommender
FROM Members as m1
